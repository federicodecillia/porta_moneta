...
export async function AppShell({ children, email, isAdmin, memberId }: AppShellProps) {
  ...
  return (
    <div className="min-h-screen bg-brand-frame sm:p-6">
      <div className="mx-auto flex min-h-screen w-full max-w-[480px] md:max-w-[640px] flex-col bg-brand-warm-white sm:min-h-[calc(100vh-3rem)] sm:overflow-hidden sm:rounded-xl sm:border sm:border-brand-border sm:shadow-sm">
        <DemoBanner />
